...
ActiveRecord::Schema.define(version: 2022_11_26_075905) do
  ...
  create_table "shipping_tos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_record_id"], name: "index_shipping_tos_on_purchase_record_id"
  end
  ...
  add_foreign_key "shipping_tos", "purchase_records"
end
