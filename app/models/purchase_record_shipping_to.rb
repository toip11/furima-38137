class PurchaseRecordShippingTo
  ...
  def save
    ...
    ShippingTo.create(postal_code: postal_code, :prefecture; prefecture, municipality: municipality, sddress: address, building_name: building_name, phone_number: phone_number, purchase_record_id: purchase.id)
  end
end